        ...
        <section class="home">
                ...
                <div class="slide-content">
                    ...
                    foreach ($componentes as $componente) {
                        if ($componente['DISPONIBLE'] == 1) {
                            ...
                            echo '<a href="borrarProducto.php?tipo=' . $tipo . '&id_producto=' . $componente['ID_PRODUCTO'] . '" class="name-slidex2">Cargar registro</a>';
                            echo '<br>';
                            echo '<br>';
                            echo '</div>';
                            echo '</div>';
            ...
            $conn = connect_database();
                echo '<form action= "borrar.php" method="post">';
                        ...
                        echo '<input type="hidden" name="id_producto" value="' . $id_producto . '" readonly>';
                        // Campo oculto para enviar el tipo de componente
                        echo '<input type="hidden" name="tipo" value="' . $tipo . '" readonly>';
